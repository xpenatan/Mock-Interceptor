...
import br.com.aisdigital.retrofit2.mock.network.RequestMultiDataModel
...
//    }
    ...
    @Test
    fun testRequestPostCompareFewSuccess() {
        val retrofitTestAPI = retrofit.create(RetrofitTestAPI::class.java)
        val requestCall = retrofitTestAPI.requestPostCompareFew(
            RequestMultiDataModel(
        ...
        Assert.assertEquals(200, code)
        Assert.assertNotNull(responseBody)
        Assert.assertEquals(231, responseBody!!.code)
    }
}
